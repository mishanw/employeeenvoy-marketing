...
<svelte:head>
  ...
  <meta
    name="description"
    content="Terms of Service for Employee Envoy. Read our terms and conditions for using the employee lifecycle management platform."
  />

  <!-- Canonical URL -->
  <link rel="canonical" href="https://employeeenvoy.com/terms" />

  <!-- Open Graph -->
  <meta property="og:title" content="Terms of Service - Employee Envoy" />
  <meta
    property="og:description"
    content="Terms and conditions for using Employee Envoy."
  />
  <meta property="og:url" content="https://employeeenvoy.com/terms" />
  <meta property="og:image" content="https://employeeenvoy.com/og-image.png" />

  <!-- Twitter Card -->
  <meta name="twitter:title" content="Terms of Service - Employee Envoy" />
  <meta
  ...
  <div class="max-w-4xl mx-auto">
    ...
    >
      <p class="text-sm text-gray-500 dark:text-gray-400 italic">
        ...
        carefully before using the Employee Envoy service operated by Employee
        Envoy ("us", "we", or "our").
      </p>

      <h2>1. Agreement to Terms</h2>
      <p>
        By accessing or using Employee Envoy, you agree to be bound by these
        Terms. If you disagree with any part of these terms, then you may not
        access the Service. These Terms apply to all visitors, users, and others
        who access or use the Service.
      </p>

      <h2>2. Description of Service</h2>
      <p>
        Employee Envoy is a Software-as-a-Service (SaaS) platform that provides
        employee lifecycle management tools, including but not limited to:
      </p>
      <ul>
      ...
      <p>
        You are responsible for safeguarding your account credentials. We are
        not liable for any loss or damage arising from your failure to comply
        with this section.
      </p>
      ...
      <p>
        ...
        limitations. Your subscription plan determines your access to features,
      ...
      <p>
        ...
        stated in these Terms. You authorize us to charge your payment method
      ...
      <p>
        ...
        at least 30 days' notice of any price increases. Price changes will
      ...
      <p>
        ...
        will continue to have access to the Service until the end of your paid
      ...
      <p>
        ...
        the Service, you consent to the collection and use of information in
        accordance with our Privacy Policy.
      </p>
      <p>
        You retain all ownership rights to your data. You grant us a limited
        license to use, store, and process your data solely to provide and
        improve the Service.
      </p>
      <p>
        You are responsible for ensuring that you have the right to provide any
        data you upload to the Service, including employee information and
        third-party credentials.
      </p>

      <h2>7. Third-Party Integrations</h2>
      <p>
        The Service integrates with third-party applications and services. Your
        use of these integrations is subject to the terms and conditions of
        those third-party services. We are not responsible for the availability,
        accuracy, or functionality of third-party services.
      </p>
      <p>
        You are responsible for maintaining valid credentials and authorizations
        for any third-party services you connect to the Service. We are not
        liable for any issues arising from third-party service failures or
        changes.
      </p>
      ...
      <p>
        ...
        design, logos, and trademarks, is owned by Employee Envoy and protected
      ...
      <p>
        We strive to maintain high availability but do not guarantee that the
        Service will be available 100% of the time. The Service may be
        unavailable due to:
      </p>
      <ul>
      ...
      <p>
        We reserve the right to modify, suspend, or discontinue any part of the
        Service at any time. We will provide reasonable notice when possible.
      </p>
      ...
      <p>
        <strong
          ...
          PURPOSE, NON-INFRINGEMENT, OR COURSE OF PERFORMANCE.</strong
        >
      </p>
      ...
      <p>
        <strong
          >TO THE MAXIMUM EXTENT PERMITTED BY LAW, IN NO EVENT SHALL EMPLOYEE
          ENVOY, ITS AFFILIATES, AGENTS, DIRECTORS, EMPLOYEES, SUPPLIERS, OR
      ...
      <p>
        <strong
          >OUR TOTAL LIABILITY FOR ALL CLAIMS ARISING OUT OF OR RELATING TO THE
          USE OF OR ANY INABILITY TO USE ANY PORTION OF THE SERVICE SHALL NOT
          EXCEED THE AMOUNT YOU PAID TO US IN THE TWELVE (12) MONTHS PRIOR TO
          THE ACTION GIVING RISE TO THE LIABILITY, OR ONE HUNDRED DOLLARS
          ($100), WHICHEVER IS GREATER.</strong
        >
      </p>
      <p>
        The above limitations apply even if we have been advised of the
      ...
      <p>
        ...
        well as any losses, liabilities, damages, costs, and expenses (including
      ...
      <ul>
        ...
        <li>
          Your violation of any third-party right, including privacy or
      ...
      <ul>
        ...
        <li>
          We may delete your account and data after a reasonable retention
          period
        </li>
        <li>
      ...
      <p>
        You may export your data at any time through the Service's export
        features. Upon account termination, you may request deletion of your
        data. We will delete your data within 30 days of your request, except
        where we are required to retain it by law or for legitimate business
        purposes.
      </p>
      ...
      <p>
        ...
        agreement between you and Employee Envoy regarding the Service and
      ...
      <p>
        ...
        reasonable control, including natural disasters, war, terrorism, labor
        disputes, or internet or telecommunications failures.
      </p>
      ...
      <p class="text-sm text-gray-500 dark:text-gray-400">
        By using Employee Envoy, you acknowledge that you have read, understood,

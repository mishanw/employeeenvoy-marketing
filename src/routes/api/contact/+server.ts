...
export const POST: RequestHandler = async ({ request, platform }) => {
  try {
    ...
    const { name, email, company, phone, subject, message, plan } = body;
          ...
          <div style="background: #f9fafb; padding: 24px; border: 1px solid #e5e7eb; border-top: none; border-radius: 0 0 8px 8px;">
            <table style="width: 100%; border-collapse: collapse;">
              ...
              <tr>
                ...
                <td style="padding: 12px 0; border-bottom: 1px solid #e5e7eb; color: #111827;"><a href="mailto:${email}" style="color: #f59e0b;">${email}</a></td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td style="padding: 12px 0; border-bottom: 1px solid #e5e7eb; color: #111827;">${plan}</td>
              </tr>
              ` : ''}
            </table>
            ...
            <div style="margin-top: 24px;">
              ...
              <div style="background: white; padding: 16px; border-radius: 8px; border: 1px solid #e5e7eb; color: #374151; white-space: pre-wrap;">${message}</div>
            </div>
            ...
            <div style="margin-top: 24px; padding-top: 16px; border-top: 1px solid #e5e7eb; color: #9ca3af; font-size: 12px;">
              ...
              <p style="margin: 8px 0 0 0;">Reply directly to this email to respond to ${name}.</p>
            </div>
          </div>
        </div>
      `,

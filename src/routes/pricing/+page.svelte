<script lang="ts">
  ...
  const comparisonFeatures = [
    ...
    { name: 'Approval Chains', starter: false, professional: true, enterprise: true },
    { name: 'Approval Delegation', starter: false, professional: true, enterprise: true },
    { name: 'Bulk Import (CSV)', starter: true, professional: true, enterprise: true },
    { name: 'Onboarding Surveys', starter: true, professional: true, enterprise: true },
    { name: 'Auto-Offboarding', starter: false, professional: true, enterprise: true },
    { name: 'Access Reviews (SOC 2)', starter: false, professional: false, enterprise: true },

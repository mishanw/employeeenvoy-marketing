  ...
  <div class="max-w-4xl mx-auto">
    ...
    <div class="bg-white dark:bg-slate-800 rounded-2xl border-2 border-gray-200 dark:border-slate-700 p-8 md:p-12 prose prose-slate dark:prose-invert max-w-none">
      ...
      <p class="text-sm text-gray-500 dark:text-gray-400 italic">
        This Privacy Policy describes how Employee Envoy ("we", "us", or "our") collects, uses, and protects your information when you use our Service.
      </p>
      ...
      <ul>
        <li><strong>Account Information:</strong> Name, email address, organization name, phone number, and password</li>
        <li><strong>Employee Data:</strong> Employee names, email addresses, departments, roles, and other information you input into the Service</li>
        <li><strong>Integration Credentials:</strong> API keys, tokens, and other authentication credentials for third-party services (encrypted and stored securely)</li>
      ...
      <ul>
        <li><strong>Provide and Maintain the Service:</strong> Process your requests, manage your account, and deliver features</li>
        <li><strong>Communicate with You:</strong> Send service-related notices, support responses, and important updates</li>
        <li><strong>Improve the Service:</strong> Analyze usage patterns, identify issues, and develop new features</li>
      ...
      <ul>
        ...
        <li><strong>Right to Non-Discrimination:</strong> Non-discrimination for exercising your privacy rights</li>
      </ul>

      <h3 id="do-not-sell">Do Not Sell My Personal Information</h3>
      <p>
        <strong>We do not sell personal information.</strong> Employee Envoy has never sold personal information and has no plans to do so.
      </p>
      ...
      <p class="text-sm text-gray-500 dark:text-gray-400">
        By using Employee Envoy, you acknowledge that you have read and understood this Privacy Policy.
      </p>
    </div>

...
>
  <div class="max-w-6xl mx-auto">
    ...
    <div class="grid lg:grid-cols-2 gap-12">
        ...
        <div class="space-y-8">
          <div>
            ...
            <p class="text-gray-600 dark:text-gray-300 mb-8">
              Prefer to reach out directly? Use the information below or fill
              out the form.
            </p>
          </div>
          ...
          <div class="space-y-6">
            <div class="flex items-start gap-4">
              <div
                class="w-12 h-12 rounded-xl bg-amber-100 dark:bg-amber-900/30 flex items-center justify-center flex-shrink-0"
              >
              ...
              <div>
                ...
                <a
                  href="mailto:hello@employeeenvoy.com"
            ...
            <div class="flex items-start gap-4">
              ...
              <div>
                ...
                <a
                  href="mailto:sales@employeeenvoy.com"
                  class="text-amber-600 dark:text-amber-400 hover:underline"
                >
                  sales@employeeenvoy.com
                </a>
                <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">
                  Enterprise plans & custom solutions
                </p>
              </div>
            </div>
          </div>
          ...
          <div
            class="p-6 rounded-2xl bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800"
          >
            <h3 class="font-semibold text-gray-900 dark:text-white mb-2">
              Enterprise Sales
            </h3>
            <p class="text-sm text-gray-600 dark:text-gray-300 mb-4">
              Need a custom plan or on-premise deployment? Our sales team can
              help design a solution that fits your needs.
            </p>
            <p class="text-sm text-gray-600 dark:text-gray-300">
              <span class="font-medium">Need help getting started?</span> Ask about
              our guided onboarding service.
            </p>
          </div>
        </div>
      </div>
      ...
      <div>
        <div
          class="bg-white dark:bg-slate-800 rounded-2xl border-2 border-gray-200 dark:border-slate-700 p-8"
        >
          {#if submitted}
            ...
            >
              ...
              <div>
                ...
                <input
                  ...
                  class="w-full px-4 py-3 rounded-lg border border-gray-300 dark:border-slate-600 bg-white dark:bg-slate-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-amber-500 focus:border-transparent {errors.name
                    ? 'border-red-500'
                    : ''}"
              ...
              <div>
                ...
                <input
                  ...
                  class="w-full px-4 py-3 rounded-lg border border-gray-300 dark:border-slate-600 bg-white dark:bg-slate-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-amber-500 focus:border-transparent {errors.email
                    ? 'border-red-500'
                    : ''}"
              ...
              <div>
                ...
                <input
                  ...
                  class="w-full px-4 py-3 rounded-lg border border-gray-300 dark:border-slate-600 bg-white dark:bg-slate-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-amber-500 focus:border-transparent {errors.company
                    ? 'border-red-500'
                    : ''}"
              ...
              <div>
                ...
                <textarea
                  ...
                  rows="6"
                  class="w-full px-4 py-3 rounded-lg border border-gray-300 dark:border-slate-600 bg-white dark:bg-slate-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-amber-500 focus:border-transparent {errors.message
                    ? 'border-red-500'
                    : ''}"
